...
export const DONATION_PROOF_ABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "string", name: "donationId", type: "string" },
  ...
  {
    inputs: [{ internalType: "string", name: "_donationId", type: "string" }],
    name: "getProof",
    outputs: [
      { internalType: "string", name: "allocationId", type: "string" },
  ...
  {
    inputs: [
      { internalType: "string", name: "_donationId", type: "string" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string[]", name: "_allocationIds", type: "string[]" },
      { internalType: "string[]", name: "_beneficiaryIds", type: "string[]" },
      { internalType: "uint256[]", name: "_amounts", type: "uint256[]" },
      { internalType: "string[]", name: "_currencies", type: "string[]" },
      { internalType: "string[]", name: "_purposes", type: "string[]" },
      { internalType: "string[]", name: "_proofHashes", type: "string[]" },
      { internalType: "string[]", name: "_proofTypes", type: "string[]" },
    ],
    name: "recordProofBatch",
    stateMutability: "nonpayable",
    type: "function",
    outputs: [],
  },
