...
const programs = [
  {
    ...
    image: SetImageGoogleById("1Jg_dFVRoN5RdAL_SMPf0zfRoV5eGW-Fb"),
    icon: BookOpen,
  ...
  },
  {
    ...
    image: SetImageGoogleById("1krNEpiAcE7439MViDm94xj4_9hzgYZfI"),
    icon: Stethoscope,
    color: "from-red-700/50 to-red-200/30",
  },
  {
    ...
    image: SetImageGoogleById("1KE4NJ82ptEacwQ8ezBMtIvQemiskxbpA"),
    icon: TreePine,
    color: "from-red-700/50 to-red-200/30",
  },
  {
    ...
    image: SetImageGoogleById("1SujHNFWcO1PzrK5P19nbG2xk0PZMFCwe"),
    icon: Sparkles,
    color: "from-red-700/50 to-red-200/30",
  },
];
...
const AboutPage = () => {
    ...
    const image = [
        ...
        { id: 2, image: SetImageGoogleById("1pqAS3_aLMJifbKDtp5Usc5rUUUMDKzaZ") },
        { id: 3, image: SetImageGoogleById("1ooXO5f-M-TWomZpzarTZbZT5wMsdVudz") },
        { id: 4, image: SetImageGoogleById("190Etw9XHnWrsYNGQo3hg4nSkKKi4sbEz") },
        { id: 5, image: SetImageGoogleById("1-HmGH2dPSJQAmYcm1woOOA5gZDHd8c4s") },
        { id: 6, image: SetImageGoogleById("1MutD4EDFqIGfq71YhT5lc_NdV4bcmMrl") },
    ]
...
const staffMembers: StaffMember[] = [
    {
        ...
        image: SetImageGoogleById('118Hqqi_ffio8PCZvThVMK_qJwJWHGXIv'),
